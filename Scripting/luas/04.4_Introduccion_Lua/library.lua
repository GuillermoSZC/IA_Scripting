...
function drawCreature(the_layer, name, posX, posY)
    ...
    --he tenido que meter las variables del grifo manualmente porque "name" no estaa funcionando
    texture_name = "grifo.png"
...
function getCreatureSize(name)
    --he tenido que meter las variables del grifo manualmente porque el
    --"griphon" que viene de base no esta funcionando
    return 128, 128
end
